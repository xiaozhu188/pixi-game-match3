...
export class Match3Process {
    ...
    public async start() {
        ...
        this.round = 0;
        console.log(`%c[Match3] ======= PROCESSING START ==========`, 'color: green');
    ...
    private async processRegularMatches() {
        ...
        console.log('Grid after processRegularMatches:\n' + match3GridToString(this.match3.board.grid));
    }
    ...
    private async applyGravity() {
        ...
        console.log('[Match3] Apply gravity - should fall in pieces:', changes.map(c => `from${c[0].row}:${c[0].column}to${c[1].row}:${c[1].column}`).join(" "));
        console.log('Grid after applyGravity:\n' + match3GridToString(this.match3.board.grid));
    ...
    private async refillGrid() {
        const emptyPositions = match3FillUp(this.match3.board.grid, this.match3.board.commonTypes);
        console.log('[Match3] Refill grid - new pieces:', emptyPositions);
        console.log('Grid after FillUp:\n' + match3GridToString(this.match3.board.grid));
        const animPromises: Promise<void>[] = [];
    ...
    public async end() {
        ...
        console.log('[Match3] Final Grid:\n' + match3GridToString(this.match3.board.grid));
        console.log('%c[Match3] ======= PROCESSING COMPLETE =======', 'color: green');
